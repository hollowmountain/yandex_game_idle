...
while ($listener.IsListening) {
  ...
  try {
    ...
    # Заглушка SDK лежит в tools/sdk-mock.js и подключается вручную из
    # консоли браузера: игра ходит за настоящим загрузчиком на yandex.ru,
    # подменять его на уровне сервера незачем.
